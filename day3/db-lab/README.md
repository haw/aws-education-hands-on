...
#### インバウンドルール
- ルールを追加 > タイプ「MySQL/Auroraルール」にソースを「`web-server-sg` のセキュリティグループIDとするルールを追加」(※🔍️に「`web-server-sg`」を入力して選択)
...
---
※ **⚠️ [Day 4: 高可用性システム ハンズオン](../../day4/ha-system-lab/README.md) からたどった場合は、ここで、Day 4の手順へ戻ってください。**  
...
3. アプリケーションの状態を確認
    ...
    **失敗している場合は、たいてい以下のどちらかに問題がある**  
    ...
    - セキュリティグループ（`database-sg`）の設定誤り → Phase 3のStep 3 を参考に設定しなおす  
